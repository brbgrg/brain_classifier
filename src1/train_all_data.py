...
def train_model_on_all_data(graphs, labels, dataset_name, best_params, max_epochs, batch_size, device):
    """
    Trains the model on all the provided graphs and labels for a specified number of epochs, saves the best model, and plots training curves.
